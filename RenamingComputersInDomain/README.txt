...
# to allocate each one to a PC that got already its own serial number from the manufacturer (They put a ticket on the hardware)
...
# hasn't changed it's name to the corresponding value of its hardware serial number
#
